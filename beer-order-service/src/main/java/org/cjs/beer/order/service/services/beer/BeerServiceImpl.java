package org.cjs.beer.order.service.services.beer;
...
/**
 * The BeerService makes REST requests to a BeerService to fetch details of a beer
 */
@ConfigurationProperties(prefix = "org.cjs", ignoreUnknownFields = false)
@Service
